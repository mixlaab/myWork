...
\begin{block}{Requisitos generales del proyecto}
    \begin{itemize}
        ...
        \item Prohibido el uso de tarjetas controladoras de vuelo. La programación será desarrollada por los integrantes del equipo. Puede usarse Arduino o Raspberry Pi.
